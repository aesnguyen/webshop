...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{ asset('/public/images/prime.png') }}" alt="logo" width="50" height="30">

    <title>The PrimeGallery</title>
    ...
    {{-- <link href="{{ asset(/public/'bootstrap/css/ie10-viewport-bug-workaround.css') }}" rel="stylesheet"> --}}

    <!-- Custom styles for this template -->
    <link href="{{ asset('front-end/front-end-style.css') }}" rel="stylesheet">
    <link rel='stylesheet' id='camera-css'  href="{{ asset('/public/css/camera.css') }}" type='text/css' media='all'>
    <link rel='stylesheet' id='camera-css' href="{{ asset('/public/css/cam-1.css') }}" type='text/css' media='all'>
    ...
    {{-- <script type='text/javascript' src="{{ asset('/public/bootstrap/js/ie-emulation-modes-warning.js') }}"></script> --}}
    <script type='text/javascript' src="{{ asset('/public/js/ads.js') }}"></script> 
