...
@section('content')
    ...
    <h3 class="panel-title">
      ...
      <span class="glyphicon glyphicon-chevron-right" style="font-size: 18px; color:#FFF; margin-left:5px; margin-right:5px"></span><a href="{!!url('/item')!!}" title="" style="color:#FFF;text-decoration: none; ">Items</a>
            ...
            <div class="panel-body">
              ...
              <!-- hot new content -->
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding" >
                  <h3 class="pro-detail-title"><a href="{!!url('/item/'.$data->id.'-'.$data->slug)!!}" title="" style="color:#BFBFBF;text-decoration: none;  background-color: ">{!!$data->name!!}</a></h3>
                  <hr>
                  <div class="row">
    ...
    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 no-padding">            
      ...
      <div class="panel panel-info" style="background-color:rgba(255,255,255,0.1); border-color:rgba(255,255,255,0.1)">
        ...
        @foreach($items as $row)
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding" >
            <div class="thumbnail mobile" style="background-color:transparent; border-color:transparent; color:#BFBFBF; height:640px;">              
              <div class="bt">
