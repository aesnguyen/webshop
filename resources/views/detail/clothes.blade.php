...
@section('content')
    ...
    <h3 class="panel-title">
      ...
      <span class="glyphicon glyphicon-chevron-right" style="font-size: 18px; color:#FFF; margin-left:5px; margin-right:5px"></span><a href="{!!url('/clothes')!!}" title="" style="color:#FFF;text-decoration: none; ">Clothes</a>
            ...
            <div class="panel-body">
              ...
              <!-- hot new content -->
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no-padding" >
                  <h3 class="pro-detail-title"><a href="{!!url('/clothes/'.$data->id.'-'.$data->slug)!!}" title="" style="color:#BFBFBF;text-decoration: none;  background-color: ">{!!$data->name!!}</a></h3>
                  <hr>
                  <div class="row">
                  ...
                  <div class="table-responsive" > 
                    <div class="panel panel-default" style="background-color:transparent; color:#BFBFBF">        
                      ...
                      <div id="links">
                        @foreach($data->detail_img as $row)
                          <a href="{!!url('uploads/products/details/'.$row->images_url)!!}" title="{!!$data->name!!}" data-gallery>
                              <img src="{!!url('uploads/products/details/'.$row->images_url)!!}" alt="{!!$data->name!!}"  width="24.3%" height="120" style="color:#BFBFBF">
                          </a>
                        @endforeach                          
                      </div>
                        <!-- The Bootstrap Image Gallery lightbox, should be a child element of the document body -->
              ...
              <div class="row">
                <hr>
                <h2 style="padding-left: 20px; "><small style="color:#FFF">News</small></h2>
                <hr>
            ...
            <div class="thumbnail mobile" style="background-color:transparent; border-color:transparent; color:#BFBFBF; height:750px;">              
              <div class="bt">
               ...
               <div class="ct" style="padding-left:5px;padding-right:5px; font-size:18px">
                ...
                <a href="{!!url('clothes/'.$row->id.'-'.$row->slug)!!}" title="More Information" style="color:#BFBFBF; text-decoration: none; float: left;margin-top:20px">
                  <span class="label label-info" style="margin-top:10px; background-color:transparent; border-width:0.1px; border:solid;color:#BFBFBF">Quality</span>   
                    <li style="font-size:15px;padding-bottom:5px"><span class="glyphicon glyphicon-ok-sign" style="padding-top:10px;margin-right:5px;color:#BFBFBF; font-weight:bold"></span>Original</li> 
