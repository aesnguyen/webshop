...
{    
    ...
    public function create(Request $rq)
    {
        ...
        try {
            ...
            ->with(['flash_level'=>'result_msg','flash_massage'=>'Pay successfully !']);     
            } else {
                return redirect()->route('getcart')
                ->with(['flash_level'=>'result_msg','flash_massage'=>' Pay failed!']);  
            }
        } catch (Exception $e) {
            return redirect()->route('getcart')
                ->with(['flash_level'=>'result_msg','flash_massage'=>'Sorry, the problem occurs !']);
        }
    }
