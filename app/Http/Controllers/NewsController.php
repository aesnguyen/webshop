...
class NewsController extends Controller
{
    ...
    public function postadd(AddNewsRequest $rq)
    {
    	...
    	return redirect('admin/news')
      	->with(['flash_level'=>'result_msg','flash_massage'=>' Added successfully !']);    	
    }
	...
	public function getdel($id){
        ...
        $article->delete();
		return redirect('admin/news')
		->with(['flash_level'=>'result_msg','flash_massage'=>' Removed successfully!']);
	}
    public function postedit(EditNewsRequest $rq,$id)
    {
    	...
    	$n->save();
    	return redirect('admin/news')
      	->with(['flash_level'=>'result_msg','flash_massage'=>' Edited successfully!']);
    }
}
